...
public class BTreeUT
{
	...
	@Test
	void testDelete_emptyLeaf_shiftLeft()
	{
		int t=3;
		BNode child1=createNode(t, new int[]{1, 2}, true, null);
	...
	@Test
	void testDelete_emptyLeaf_merge()
	{
		int t=3;
		BNode child1=createNode(t, new int[]{1, 2}, true, null);
		BNode child2=createNode(t, new int[]{11, 12}, true, null);
	...
	@Test
	void testDelete_internalNode_replaceWithPredecessor()
	{
		int t=3;
		BNode child1=createNode(t, new int[]{1, 2, 3}, true, null);
	...
	@Test
	void testDelete_internalNode_replaceWithSuccessor()
	{
		int t=3;
		BNode child1=createNode(t, new int[]{1, 2}, true, null);
		BNode child2=createNode(t, new int[]{11, 12, 13}, true, null);
	...
	@Test
	void testDelete_internalNode_mergeChildren()
	{
		int t=3;
		BNode child1=createNode(t, new int[]{1, 2}, true, null);
		BNode child2=createNode(t, new int[]{11, 12}, true, null);
	...
	@Test
	void testDelete_deleteFromRoot_rootHasOneItem_createNewRoot()
	{
		int t=3;
		BNode child1=createNode(t, new int[]{1, 2}, true, null);
		BNode child2=createNode(t, new int[]{11, 12}, true, null);
	...
	@Test
	void testDelete_internalNodeTooSmallToDeleteFrom_ShiftLeft()
	{
		int t=2;
	...
	@Test
	void testDelete_internalNodeTooSmallToDeleteFrom_ShiftRight()
	{
		int t=2;
		BNode leaf1=createNode(t, new int[]{5}, true, null);
		BNode leaf2=createNode(t, new int[]{15}, true, null);
	...
	@Test
	void testDelete_internalNodeTooSmallToDeleteFrom_Merge()
	{
		int t=2;
