...
public class Assignment4Tests
{
	...
	private static void testInsert()
	{
		...
		ArrayList<Integer> arrayListFirst=inorder(new ArrayList<Integer>(), firstTree.getRoot());
		...
		Test(true, checkDegree(firstTree, firstTree.getRoot()), "Insert - Test 3 of 7",
		     "found nodes with less than t-1 blocks or with more than 2t-1 blocks");
		Test(true, checkNumOfChildren(firstTree, firstTree.getRoot()), "Insert - Test 4 of 7",
		     "found nodes with less or more than numOfBlocks+1 children");
		
		//same test as the previous but with more nodes.
		BTree SecondTree=new BTree(15);
		initTree(SecondTree, 10000);
		ArrayList<Integer> arrayListSecond=inorder(new ArrayList<Integer>(), SecondTree.getRoot());
		...
		Test(true, checkDegree(SecondTree, SecondTree.getRoot()), "Insert - Test 6 of 7",
		     "found nodes with less than t-1 blocks or with more than 2t-1 blocks");
		Test(true, checkNumOfChildren(SecondTree, SecondTree.getRoot()), "Insert - Test 7 of 7",
		     "found nodes with less or more than numOfBlocks+1 children");
	...
	private static void testDelete()
	{
		...
		ArrayList<Integer> arrayList=inorder(new ArrayList<Integer>(), tree.getRoot());
		...
		tree.delete(27);
		tree.delete(25);
		Test(true, checkDegree(tree, tree.getRoot()), "Delete - Test 5 of 6",
		     "found nodes with less than t-1 blocks or with more than 2t-1 blocks");
		Test(true, checkNumOfChildren(tree, tree.getRoot()), "Delete - Test 6 of 6",
		     "found nodes with less or more than numOfBlocks+1 children");
